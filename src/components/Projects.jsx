            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-4">
                <Link
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white/10 text-gray-100 border border-white/20 text-sm font-semibold rounded-lg hover:bg-white/20 transition-all duration-300"
                >
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 bg-white/10 text-gray-100 text-sm font-semibold rounded-lg border border-white/10 hover:bg-white/20 transition-all duration-300"
                >
