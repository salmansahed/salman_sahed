...
const WebNextAdminSignup = () => {
  ...
  const onSubmit = async (e) => {
    ...
    const { data, error } = await authClient.signUp.email({
      name: adminData.name, // required
      email: adminData.email, // required
      password: adminData.password, // required
    });
...
export default WebNextAdminSignup;
